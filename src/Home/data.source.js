...
export const Content10DataSource = {
  ...
  content: {
    ...
    children:
      '금형 디자인을 전공한 저는 기존 전공 보다 뚜렷한 비전을 가진 소프트웨어로 눈을 돌렸습니다. IT개발자를 새로운 목표로 삼고 역량을 갖추기 위해 삼성 SDS 멀티캠퍼스에서 진행하는 ‘임베디드 소프트웨어 기반 IoT 고급 개발자 양성 과정’에 지원하여 공부했습니다. 저는 9개월 간 매일 가장 늦게 집에 가는 학생이었습니다. 모르는 것이 있으면 누구든 붙잡고 질문했습니다. 목표를 달성하기 위해 끈기는 필수였습니다. 체력이 부족해지자 새벽 수영을 등록해서 운동으로 체력을 길러가면서 공부했습니다. 그렇게 노력하여 C와 JAVA, Python 같은 기본적인 언어부터, Linux, Ruby on Rails까지 현업에 투입될 수 있을 정도의 기술을 충분히 습득할 수 있었습니다. ',
